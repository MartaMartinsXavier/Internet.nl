...
WEB_APPSECPRIV_SET_COOKIE_GOOD = FULL_WEIGHT_POINTS
WEB_APPSECPRIV_SET_COOKIE_BAD = NO_POINTS
WEB_APPSECPRIV_SET_COOKIE_WORST_STATUS = STATUS_NOTICE

WEB_APPSECPRIV_SERVER_HEADER_GOOD = FULL_WEIGHT_POINTS
WEB_APPSECPRIV_SERVER_HEADER_BAD = NO_POINTS
WEB_APPSECPRIV_SERVER_HEADER_WORST_STATUS = STATUS_NOTICE
...
#
# X-XSS-Protection
WEB_APPSECPRIV_X_XSS_PROTECTION_GOOD = STATUS_INFO
WEB_APPSECPRIV_X_XSS_PROTECTION_BAD = STATUS_NOTICE 


# X-Set-Cookie
WEB_APPSECPRIV_SET_COOKIE_GOOD = STATUS_INFO 
WEB_APPSECPRIV_SET_COOKIE_BAD = STATUS_NOTICE

# X-Server
WEB_APPSECPRIV_SERVER_HEADER_GOOD = STATUS_INFO  
WEB_APPSECPRIV_SERVER_HEADER_BAD = STATUS_INFO 
...
# new test MTA-STS has no score.
MAIL_MTASTS_PASS = FULL_WEIGHT_POINTS
MAIL_MTASTS_PARTIAL = LESS_WEIGHT_POINTS
MAIL_MTASTS_FAIL = NO_POINTS
MAIL_MTASTS_WORST_STATUS = STATUS_INFO

MAIL_MTASTS_POLICY_PASS = FULL_WEIGHT_POINTS
MAIL_MTASTS_POLICY_PARTIAL = LESS_WEIGHT_POINTS
MAIL_MTASTS_POLICY_FAIL = NO_POINTS
MAIL_MTASTS_POLICY_WORST_STATUS = STATUS_INFO
